                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            ...
                            >
                              All Rooms
                              <span className="absolute top-0 left-21 mt-1 ml-2 flex h-5 w-5 items-center justify-center rounded-full bg-blue-500 text-white text-xs">
                                {rooms.length}
                              </span>
                            </NavLink>
                          </li>
                          ...
                          <li>
                            ...
                            >
                              Available Rooms
                              <span className="absolute top-0 left-32 mt-1 ml-2 flex h-5 w-5 items-center justify-center rounded-full bg-green-500 text-white text-xs">
                                {
                                  rooms.filter(
                                    (room: Room) => room.isOccupied === false
                                  ).length
                                }
                              </span>
                            </NavLink>
                          ...
                          <li>
                            ...
                            >
                              Occupied Rooms
                              <span className="absolute top-0 left-34 mt-1 ml-2 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-white text-xs">
                                {
                                  rooms.filter(
                                    (room: Room) => room.isOccupied === true
                                  ).length
                                }
                              </span>
                            </NavLink>
